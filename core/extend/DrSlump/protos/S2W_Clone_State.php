...
// @@protoc_insertion_point(namespace:.net_message.S2W_Clone_State)
 ...
 * @method string getNState()
 * @method void setNState(\string $value)
 * @method string getNSystemType()
 * @method void setNSystemType(\string $value)
 * @method string getNDriveState()
 * @method void setNDriveState(\string $value)
 * @method string getNPowerState()
 * @method void setNPowerState(\string $value)
 * @method string getNSystemWorkState()
 * @method void setNSystemWorkState(\string $value)
 * @method string getNEngineWorkState()
 * @method void setNEngineWorkState(\string $value)
 * @method string getNSpeed()
 * @method void setNSpeed(\string $value)
 * @method string getNUsedTime()
 * @method void setNUsedTime(\string $value)
 * @method string getNHigh()
 * @method void setNHigh(\string $value)
 * @method string getNLow()
 * @method void setNLow(\string $value)
 * @method string getNIsUpdateDb()
 * @method void setNIsUpdateDb(\string $value)
 * @method string getNProgress()
 * @method void setNProgress(\string $value)
 * @method string getNMirrorPartition()
 * @method void setNMirrorPartition(\string $value)
 * @method string getSFileSystemDescription()
 * @method void setSFileSystemDescription(\string $value)
 * @method string getSSystemWorkDescription()
 * @method void setSSystemWorkDescription(\string $value)
 * @method string getSUuid()
 * @method void setSUuid(\string $value)
 */
class S2W_Clone_State extends \DrSlump\Protobuf\Message
{
  // @@protoc_insertion_point(traits:.net_message.S2W_Clone_State)
  ...
  /**
   * @var string $nSystemWorkState
   * @tag 7
   * @label required
   * @type \ProtocolBuffers::TYPE_UINT32
   **/
  public $nSystemWorkState;
  
  /**
   * @var string $nEngineWorkState
   * @tag 8
   * @label required
   * @type \ProtocolBuffers::TYPE_UINT32
   **/
  public $nEngineWorkState;
  ...
  /**
   * @var string $nMirrorPartition
   * @tag 15
   * @label required
   * @type \ProtocolBuffers::TYPE_UINT32
   **/
  public $nMirrorPartition;
  
  /**
   * @var string $sFileSystemDescription
   * @tag 16
   * @label required
   * @type \ProtocolBuffers::TYPE_STRING
   **/
  public $sFileSystemDescription;
  
  /**
   * @var string $sSystemWorkDescription
   * @tag 17
   * @label required
   * @type \ProtocolBuffers::TYPE_STRING
   **/
  public $sSystemWorkDescription;
  ...
  public $sUuid;
    ...
    // @@protoc_insertion_point(properties_scope:.net_message.S2W_Clone_State)

  // @@protoc_insertion_point(class_scope:.net_message.S2W_Clone_State)
  ...
  public static function descriptor()
  {
    ...
    //if (!isset($descriptor)) 
      ...
      // @@protoc_insertion_point(builder_scope:.net_message.S2W_Clone_State)
