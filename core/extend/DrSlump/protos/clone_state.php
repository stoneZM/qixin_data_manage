...
namespace tests {
  ...
  class Clone_state extends \DrSlump\Protobuf\Message {
...
/////////////////W2S_Message////////////////////////////////////
 /**
  ...
  /*
	DWORD    dwWebUserID;
	// if refresh clients :==0 refresh a client ,==1 refresh a group
	// if deploy task:==0 deploy task to a client ,==1 deploy task to a group
	WORD     wType;
	// the size of szUserID and szRemark and szReserve
	WORD     wSize[3];
	// szUserID:may be a client id,may be a group id,may be a storage id
	char     szUserID[60];
	char     szPath[MAX_PATH*4];
	char     szReserve[MAX_PATH*4];
*/
...
/////////////////////////////////////////////////////
    ...
    /** @var \Closure[] */
    public  static $__extensions = array();
