...
// @@protoc_insertion_point(namespace:.net_message.W2S_DB_Info)
 ...
 * @method string getNDbType()
 * @method void setNDbType(\string $value)
 * @method string getNLoginType()
 * @method void setNLoginType(\string $value)
 * @method string getNIfSave()
 * @method void setNIfSave(\string $value)
 * @method string getNPort()
 * @method void setNPort(\string $value)
 * @method string getSServer()
 * @method void setSServer(\string $value)
 * @method string getSUserName()
 * @method void setSUserName(\string $value)
 * @method string getSPwd()
 * @method void setSPwd(\string $value)
 * @method string getSUserId()
 * @method void setSUserId(\string $value)
 * @method string getSRemark()
 * @method void setSRemark(\string $value)
 */
class W2S_DB_Info extends \DrSlump\Protobuf\Message
{
  // @@protoc_insertion_point(traits:.net_message.W2S_DB_Info)
...
/////////////////W2S_Message////////////////////////////////////
  ...
  protected static $__extensions = array();  // @@protoc_insertion_point(properties_scope:.net_message.W2S_DB_Info)

  // @@protoc_insertion_point(class_scope:.net_message.W2S_DB_Info)
    ...
    if (!isset($descriptor)) {
      ...
      */
	  ...
	  /*  "optional" => false;
        ...
        "default"  => "";
      */
      // @@protoc_insertion_point(builder_scope:.net_message.W2S_DB_Info)
