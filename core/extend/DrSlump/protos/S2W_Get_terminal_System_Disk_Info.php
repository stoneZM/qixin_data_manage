...
// @@protoc_insertion_point(namespace:.net_message.S2W_Get_terminal_System_Disk_Info)
 ...
 * @method string getNDriveLetter()
 * @method void setNDriveLetter(\string $value)
 * @method string getNUsedHigh()
 * @method void setNUsedHigh(\string $value)
 * @method string getNUsedLow()
 * @method void setNUsedLow(\string $value)
 * @method string getNTotalHigh()
 * @method void setNTotalHigh(\string $value)
 * @method string getNTotalLow()
 * @method void setNTotalLow(\string $value)
 * @method string getSFileSystem()
 * @method void setSFileSystem(\string $value)
 * @method string getSSystemVersion()
 * @method void setSSystemVersion(\string $value)
 * @method string getSData()
 * @method void setSData(\string $value)
 */
class S2W_Get_terminal_System_Disk_Info extends \DrSlump\Protobuf\Message
{
  // @@protoc_insertion_point(traits:.net_message.S2W_Get_terminal_System_Disk_Info)
  ...
  /**
   * @var string $sSystemVersion
   * @tag 9
   * @label required
   * @type \ProtocolBuffers::TYPE_STRING
   **/
  public $sSystemVersion;
  ...
  public $sData;
    ...
    // @@protoc_insertion_point(properties_scope:.net_message.S2W_Get_terminal_System_Disk_Info)

  // @@protoc_insertion_point(class_scope:.net_message.S2W_Get_terminal_System_Disk_Info)
  ...
  public static function descriptor()
  {
    ...
    if (!isset($descriptor)) {
      ...
      $f->name      =  "sData";
      $f->rule      = \DrSlump\Protobuf::RULE_OPTIONAL;
      // @@protoc_insertion_point(builder_scope:.net_message.S2W_Get_terminal_System_Disk_Info)
